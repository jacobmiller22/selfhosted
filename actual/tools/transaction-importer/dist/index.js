        ...
        for (const filePath of filesToProcess) {
            ...
            try {
                ...
                if (isImageFile(filePath)) {
                    ...
                    console.log(`   Extracted ${visionResult.transactions.length} transaction(s). Detected account: ${visionResult.account_identifier || "Unknown"}${visionResult.resolvedAccountName ? ` -> "${visionResult.resolvedAccountName}"` : ""}`);
                    explicitResolvedAccountId = visionResult.resolvedAccountId;
                    parsed = {
                        accountStatements: [
                            {
                                accountNumber: visionResult.account_last_4 || visionResult.account_identifier,
