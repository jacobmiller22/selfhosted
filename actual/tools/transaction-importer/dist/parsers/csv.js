...
export function parseCsvContent(content, filename, profile) {
    ...
    const getHeader = (profileHeader, patterns) => {
        if (profileHeader !== undefined) {
            if (profileHeader === '' || profileHeader === '(None)')
                return undefined;
...
function parseAmountValue(rawStr) {
    if (!rawStr)
        return 0;
