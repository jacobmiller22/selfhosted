 ...
 * - MM/DD/YY or M/D/YY
 */
export function normalizeQifDate(rawDate: string): string {
...
export function parseQifContent(content: string): ParsedStatement {
  const accountStatements: AccountStatement[] = [];

  let currentAccountNumber: string | undefined = undefined;
  let currentTransactions: TransactionToImport[] = [];
  ...
  for (const block of blocks) {
    ...
    let accountNameInBlock: string | undefined = undefined;
