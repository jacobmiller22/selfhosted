...
If no screenshots are found, prompt the user:
> *"No new screenshots found in `~/Downloads/budget`. Please AirDrop or drop your banking screenshots into `~/Downloads/budget` or attach them directly in this chat!"*
