#!/usr/bin/env bash
# ==============================================================================
# Container Entrypoint for Standardized Backup Runner (Vaultwarden)
# ==============================================================================
...
export SERVICE_NAME="${SERVICE_NAME:-vaultwarden}"
export BACKUP_SOURCE_DIR="${BACKUP_SOURCE_DIR:-/tmp/vw-data}"
...
export BACKUP_DEST_PREFIX="${BACKUP_DEST_PREFIX:-backups/vaultwarden}"
...
echo "[+] Service: ${SERVICE_NAME:-vaultwarden}"
